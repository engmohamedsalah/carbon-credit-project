...
- **Documented for deployment**: Clear usage guidelines and measured performance (F1 ≈ 0.49)
...
**Status**: Trained and evaluated (F1 ≈ 0.49); research prototype with a clear enhancement roadmap 